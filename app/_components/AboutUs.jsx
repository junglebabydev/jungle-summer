...
export function AboutUs() {
  ...
  return (
    <div style={{ background: '#fff', minHeight: 'calc(100vh - 400px)', fontFamily: 'Manrope, sans-serif' }}>
      <div style={{ maxWidth: 1000, margin: '0 auto', padding: isMobile ? '40px 20px 60px' : '60px clamp(20px,4vw,48px) 80px' }}>
        {/* Hero Section */}
        <div style={{ marginBottom: isMobile ? 40 : 60 }}>
          <h1 style={{ fontFamily: '"Feather Bold", serif', fontSize: isMobile ? 28 : 'clamp(36px,5vw,48px)', color: '#0C3C26', marginBottom: 20, lineHeight: 1.1 }}>
            Making summer magic happen for Singapore families
          </h1>
          <p style={{ fontSize: isMobile ? 16 : 18, color: '#666', maxWidth: 700, lineHeight: 1.7 }}>
        ...
        {/* Mission Section */}
        <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: isMobile ? 24 : 40, marginBottom: isMobile ? 40 : 60 }}>
          <div style={{ padding: isMobile ? 24 : 32, background: '#E5F5ED', borderRadius: isMobile ? 16 : 20 }}>
            <h2 style={{ fontFamily: '"Feather Bold", serif', fontSize: isMobile ? 24 : 28, color: '#0C3C26', marginBottom: 16 }}>Our Mission</h2>
            <p style={{ fontSize: isMobile ? 14 : 15, color: '#666', lineHeight: 1.7 }}>
          ...
          <div style={{ padding: isMobile ? 24 : 32, background: '#F5F5F0', borderRadius: isMobile ? 16 : 20 }}>
            <h2 style={{ fontFamily: '"Feather Bold", serif', fontSize: isMobile ? 24 : 28, color: '#0C3C26', marginBottom: 16 }}>Our Story</h2>
            <p style={{ fontSize: isMobile ? 14 : 15, color: '#666', lineHeight: 1.7 }}>
        ...
        {/* Values Section */}
        <div style={{ marginBottom: isMobile ? 40 : 60 }}>
          <h2 style={{ fontFamily: '"Feather Bold", serif', fontSize: isMobile ? 26 : 32, color: '#0C3C26', marginBottom: isMobile ? 24 : 32, textAlign: 'center' }}>
            What we believe in
          </h2>
