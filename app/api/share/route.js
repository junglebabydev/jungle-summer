...
// Body: { email, eventId, eventTitle, eventVenue?, eventArea?, visitSiteUrl? }
...
export async function POST(req) {
  ...
  const from =
    ...
    "Jungle Summer <noreply@notifications.jungle.baby>";
  const title = body.eventTitle || "this thing to do";
  const link = `https://summer.jungle.baby/${body.eventId || ""}`;
